...
/**
 * lucide-react 1.x removed brand marks (GitHub, LinkedIn) for trademark reasons,
 * so we ship small inline SVGs with a lucide-compatible `className` prop.
 */
